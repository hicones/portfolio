      ...
      <InnerLayout>
        ...
        <div className="resume-content">
          ...
          <ResumeItem
            ...
            text={
              "Desenvolvimento de aplicações no segmento de crypto, utilizando TypeScript, NextJS, Redux, requisições API Rest com Axios. "
            }
          />
          <ResumeItem
            ...
            subTitle={"Turn2C"}
            text={
              "Desenvolvimento de aplicações onboarding e Crm. Desenvolvimento de projetos. Desenvolvimento UX UI utilizando Figma. Requisições API Rest com Axios. "
            }
          />
          <ResumeItem
        ...
        <div className="resume-content ">
          ...
          <ResumeItem
            ...
            subTitle={"Origamid"}
            text={
              "Aprendi a criar um site responsivo do zero. Do design ao código, utilizando HTML5, CSS3, JavaScript e com um design responsivo. "
            }
          />
        </div>
      </InnerLayout>
